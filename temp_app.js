<html lang='en'>
	...
	<body id="main" class="main hidden" onload="main()">
		...
		<script type="text/javascript" crossorigin="anonymous" id="lib-js" src="./lib.js?ver=1353"></script>
		<script type="text/javascript" crossorigin="anonymous" id="main-js" src="./main.js?ver=991"></script>
